...
function Navbar() {
  ...
  return (
    <nav className="bg-semi-dark-blue h-[56px] fixed flex items-center px-5 justify-between w-full md:w-[719px] md:h-[72px] z-10 lg:w-24 lg:h-[92%] lg:max-h-[960px] lg:flex-col lg:py-6 lg:left-5">
      <Logo />
      <ul
        className="flex gap-5 lg:flex-col lg:absolute lg:top-28"
        onClick={handleClick}
      >
        <li className="home category">
          <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              className="lg:hover:fill-red-600"
            />
          </svg>
        </li>
